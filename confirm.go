...
// ConfirmTemplateData data available to the templates when processing
...
// ConfirmQuestionTemplate Templates with Color formatting.
...
by a carriage return.
	...
	likesPie := false
	prompt := &inquirer.Confirm{ Message: "What is your name?" }
	inquirer.AskOne(prompt, &likesPie)
*/
